...
FEATURE_FILE = os.path.join(BASE_DIR, "Data", "ecoli_kmer_features_20260320_092319.csv")
LABEL_FILE = os.path.join(BASE_DIR, "balanced_data", "ecoli_ciprofloxacin_balanced.csv")

OUTPUT_FILE = os.path.join(BASE_DIR, "Data", "ecoli_final_ml_dataset.csv")
